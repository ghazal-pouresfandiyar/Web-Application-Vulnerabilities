...
$htbconf['db/.server']	= getenv('DB_HOST') ?: '127.0.0.1';
$htbconf['db/.login']	= getenv('DB_USER') ?: 'root';
$htbconf['db/.pwd']		= getenv('DB_PASSWORD') ?: 'root';
$htbconf['db/.name']	= getenv('DB_NAME') ?: 'vbank';
